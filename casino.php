			...
			<ol class="flex items-center pb-1 overflow-x-scroll whitespace-nowrap opacity-scroll">
				...
				<li class="inline-flex items-end pr-1 group">
					<div class="flex items-center">
						...
						</svg><a class="text-xs pl-1 border-b border-transparent hover:lg:border-primary transition-all duration-200 ease-in-out group-last:text-primary undefined" href="casino">Casino</a>
					</div>
				</li>
			</ol>
		</nav>
		<img alt="Casino Page Banner" fetchpriority="high" width="1500" height="0" decoding="async" data-nimg="1" class="rounded-lg w-full h-36 md:h-auto object-center object-cover" src="https://cdn.databerjalan.com/cdn-cgi/image/width=auto,quality=75,fit=contain,format=auto//assets/images/static/v3/banner/casino-new.webp" style="color: transparent;">
		<div class="flex flex-wrap -mx-2 mt-4 lg:mt-8">
			<?php
			// Query untuk mengambil daftar provider casino dari database
			$query_provider = "SELECT * FROM tb_provider WHERE jenis = 3 AND status = 1 ORDER BY cuid ASC";
			...
			<div class="w-1/3 sm:w-1/4 lg:w-1/6 px-[6px] lg:px-3 mb-3 lg:mb-4">
				<?php $href = $alamat_website . 'casino?provider=' . strtolower($gambar_provider); ?>
				<a href="<?php echo $href; ?>" class="relative pb-3 w-full group overflow-hidden">
					<div class="w-full rounded-xl lg:rounded-2xl" style="box-shadow: rgba(204, 210, 227, 0.5) 0px 0px 28.8428px inset;">
						<figure class="relative overflow-hidden rounded-xl lg:rounded-2xl"><img alt="casino-<?php echo $nama_provider; ?>" fetchpriority="high" width="0" height="0" decoding="async" data-nimg="1" class="w-full group-hover:lg:scale-110 transition-all duration-300 ease-in-out" src="uploads/provider/casino/<?= $gambar_provider; ?>.png" style="color: transparent;"></figure>
					</div>
...
// ambil data provider
$query_provider = "SELECT * FROM tb_provider WHERE slug = ? AND jenis = 3";
        ...
        <ol class="flex items-center pb-1 overflow-x-scroll whitespace-nowrap opacity-scroll">
            ...
            <li class="inline-flex items-end pr-1 group">
                <div class="flex items-center"><svg width="17" height="17" viewBox="0 0 24 24" fill="var(--base)" xmlns="http://www.w3.org/2000/svg" size="17">
                        <path d="m15 12 .354-.354.353.354-.353.354L15 12ZM9.354 5.646l6 6-.708.708-6-6 .708-.708Zm6 6.708-6 6-.708-.708 6-6 .708.708Z" fill="var(--base)"></path>
                    </svg><a class="text-xs pl-1 border-b border-transparent hover:lg:border-primary transition-all duration-200 ease-in-out group-last:text-primary" href="<?php echo $alamat_website . 'casino'; ?>">Casino</a></div>
            </li>
            <li class="inline-flex items-end pr-1 group">
                <div class="flex items-center"><svg width="17" height="17" viewBox="0 0 24 24" fill="var(--base)" xmlns="http://www.w3.org/2000/svg" size="17">
                        <path d="m15 12 .354-.354.353.354-.353.354L15 12ZM9.354 5.646l6 6-.708.708-6-6 .708-.708Zm6 6.708-6 6-.708-.708 6-6 .708.708Z" fill="var(--base)"></path>
